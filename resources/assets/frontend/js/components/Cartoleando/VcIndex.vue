<template>
  ...
  <div class="container" v-else>
    ...
    <div class="row">
			<div class="col-12 col-md-6 col-sm-6 col-lg-4" v-for="(leaguePackage, index) in leaguePackages" :key="index" :index="index">
				<div class="soccer-expert">
					<header class="soccer-expert-header">
						...
						<img class="header-image img-fluid" :alt="leaguePackage.name" :src="leaguePackage.bg_image_domain + '/' + leaguePackage.bg_image">
						<div class="descript">
