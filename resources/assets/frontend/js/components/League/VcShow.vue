<template>
  ...
  <div class="container" v-else-if="!loading.component && league.name">
    ...
    <div class="row">
      <div class="col-lg-5 col-12 col-sm-6 vcenter col-trophy" style>
        <div class="img-fluid" :style="getStyleImage()"></div>
      </div>
      <div class="col-lg-5 col-12 col-sm-6">
        <div class="row">
          ...
          <div class="col-lg-12 col-12 col-md-12 col-sm-12">
            <h4 class="league small-description">{{ league.small_description }}</h4>
          </div>
          ...
          <div class="col-lg-3 col-12 col-md-12 col-sm-12">
            <div>
              ...
              <h5 class="league participants">{{ trans('strings.participants') }}</h5>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container" v-else>
    ...
    <div class="row">
      <h1>
        <a :href="$route.fullPath">Erro ao carregar a liga, tente novamente</a>
      </h1>
    </div>
  </div>
</template>
  ...
  methods: {
    getStyleImage() {
      let background =
        ...
        this.league.bg_image_domain +
        "/" +
        this.league.bg_image +
        ")";
      return (
